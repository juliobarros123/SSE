                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control " name="vc_email" value="{{ old('vc_email') }}"
                                    required autocomplete="vc_email" placeholder="Seu E-mail" required>
                            </div>
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('login.alunos') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group d-flex">
                        <input type="text" class="form-control rounded-left" placeholder="Seu código de acesso" required
                            name="codigo" required autocomplete="current-text">
                    </div>
                </div>
