...
@endif
    <div class="card">
        <div class="card-body">
            <form method="POST" class="row m-2" action="{{ route('admin.candidatos.recebeBI') }}">
                @csrf
                <div class="col-8">
    ...
    <div class="card" id="result">
        <div class="card-body">
            <form form action="{{ route('admin.candidatos_selecionar.cadastrar') }}" method="post" class="row">
                @csrf
