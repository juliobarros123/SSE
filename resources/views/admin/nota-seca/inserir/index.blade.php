                                ...
                                <td> {{ $aluno->vc_primeiroNome }} {{ $aluno->vc_nomedoMeio }}
                                    ...
                                    <td>
                                        <div class="form-group  bg-danger">
                                            ...
                                            name="idDCC_{{$item['id']}}_{{$aluno->id_aluno}}" value="{{ceil(mediaDisciplinaNoAno($aluno->id_aluno, $id_turma, $item['id']))>20?20:ceil(mediaDisciplinaNoAno($aluno->id_aluno, $id_turma, $item['id']))}}"    >
                                        </div>
                                    </td>
                                    @endforeach
                            </tr>
