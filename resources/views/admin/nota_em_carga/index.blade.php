...
@section('conteudo')
    ...
    @if ($estado_permissao_nota == 1)
        ...
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-dark" href="{{ url('nota_em_carga/buscar_alunos') }}">
        ...
        <tbody class="bg-white">
            ...
            @foreach ($notas as $nota)
                <tr class="text-center">
                    ...
                    <td>{{ $nota->vc_nome }}</td>
                    <td>{{ $nota->vc_classeTurma }}ª classe</td>
                    @if ($nota->fl_mac <= 9)
                    ...
                    @endif
                    @if ($nota->fl_nota2 <= 9)
                        <td class="text-danger nota2">{{ $nota->fl_nota2 }}</td>
                    @else
                        <td class="text-primary nota2">{{ $nota->fl_nota2 }}</td>
                    @endif
                    @if ($nota->fl_media <= 9)
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#" type="button" data-toggle="modal"
                                        ...
                                        data-target=".bd-example-modal-lg-{{ $nota->it_idAluno }}">Expandir</a>
                ...
                <!--Modal-->
                <div class="modal fade bd-example-modal-lg-{{ $nota->it_idAluno }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" value="  {{ $nota->ya_inicio . '-' . $nota->ya_fim }}"
                                            class="form-control form-control-border " id="" readonly>
                                    </div>
                                    <div class="form-group col-md-4">
