    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" class="" target="_blank"
                action="{{ url("nota_em_carga/inserir") }}">
                @csrf
                <input type="text" nome="trimestre" value="{{$trimestre}}" hidden>
                <input type="text" nome="slug_turma_professor" value="{{$turma_professor->slug}}" hidden>
