...
@section('titulo', 'Candidatos/Imprimir')

 @section('conteudo')
    <div class="card mt-3">
        <div class="card-body">
            <h3>Imprimir Listas dos Candidatos</h3>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.ListadCandidatura.recebeCandidaturas')}}" class="row" method="POST" target="_blank">
                @csrf
