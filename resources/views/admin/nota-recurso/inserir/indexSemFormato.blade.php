                                    ...
                                    <td>
                                        <div class="form-group  bg-danger">
                                            <input type="number" min="0" max="20" step="any"
                                                class="form-control border-secondary {{(mediaDisciplinaNoAno($aluno->id_aluno, $id_turma, $item->id))>=10?'text-primary':'text-danger'}}" placeholder="Nota"
                                            name="idDCC_{{$item->id}}_{{$aluno->id_aluno}}" value="{{(mediaDisciplinaNoAno($aluno->id_aluno, $id_turma, $item->id))}}"    >
                                        </div>
                                    </td>
                                    @endforeach
                            </tr>
