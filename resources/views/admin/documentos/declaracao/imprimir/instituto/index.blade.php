...
<body
    style="background-image: url('<?php echo ; ?>images/certificado/instituto/certificado.png');background-position: top left;
...
background-image-resolution: from-image;">
    ...
    <p class="cab-cert">
        ...
        <?php echo 'ENSINO SECUNDÁRIO TÉCNICO PROFISSIONAL '; ?>
    ...
    <p class="narracao"> a) <strong><span class="director">{{ $cabecalho->vc_nomeDirector }}</span></strong>, Director(a)
        do {{ $cabecalho->vc_escola }} n.º _______ criado sob Decreto Executivo
    ...
    <table class="table">
        ...
        @endphp
        <tr>
            <td class=" td cab-table td-boder" colspan="1" style="text-align:left">Componente de Formação
            </td>
        ...
        @foreach (componentes() as $componente)
            <tr>
                <td class=" td cab-table td-boder" colspan="4" style="text-align:left">
            ...
            @foreach (componentes_disciplinas()->where('id_componente', $componente->id)->get() as $disciplina)
                ...
                {{-- @if ($disciplina->vc_acronimo == 'E.C.S.')
                    <tr>
                        <td class="disciplina upper-case td td-boder">Média do Plano Curricular (PC) </td>
        ...
        <tr>
            ...
            <td class="disciplina upper-case td td-boder "><strong> Média Anual</strong></td>
            <td class="nota-valor td td-boder">

                {{ $media }}
            </td>
            <td class="nota-extenso td td-boder-bottom">
                {{ ucfirst(valorPorExtenso($media, false, false)) }}
            </td>
            <td class="valores td td-boder-bottom td-boder-right">Valores</td>
        ...
        {{-- <tr>
            ...
            <td class="disciplina upper-case td td-boder "><strong>Prova
        ...
        <td class="disciplina upper-case td td-boder "><strong>Nota de Estagio Curricular
            </strong></td>
        <td class="nota-valor td td-boder">
        ...
        <tr>
            ...
            <td class="disciplina upper-case td td-boder "><strong>Média Final do Curso (4º MA+PAP+NEC)/6
                </strong></td>
            <td class="nota-valor td td-boder">
            ...
            <td class="nota-extenso td td-boder-bottom">
                {{ ucfirst(valorPorExtenso($valor, false, false)) }}
            </td>
            <td class="valores td td-boder-bottom td-boder-right">Valores</td>
    ...
    {{-- <h5 class="data">{{ $cabecalho->vc_escola }} – {{ $cabecalho->vc_acronimo }}, NO ÚIGE, AOS
    {{ hoje_extenso() }}.-</h5> --}}
