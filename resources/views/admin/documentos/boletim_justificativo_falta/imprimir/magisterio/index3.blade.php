...
<body
    style="background-image: url('<?php echo ; ?>images/boletim_justificativo_falta/magisterio/boletim_justificativo_falta.png');background-position: top left;
...
background-image-resolution: from-image;">
    ...
    <div class="dados">
        ...
        <p id="p3">Ciências__________________________________________________________________ Tendo faltado na
            Aula/Prova de </p>
        <p id="p4">_____________________________,______________________________e
            _________________________________ No dia ___/____/20______ por motivos de</p>
    ...
    <div class="data">
        <span>Data: __________/__________/20_____________________________</span>
    </div>
    ...
    <div class="parecer">
        ...
        <p id="pp6">
            <span style="font-family: Arial;">Magistério</span>_________________ <span
