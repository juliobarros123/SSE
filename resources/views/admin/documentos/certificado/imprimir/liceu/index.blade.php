...
@include('admin.documentos.certificado.imprimir.fragments.visto.index')
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class=" td cab-table bg-cab-table td-boder" style="">10ª Classe</td>
            <td class=" td cab-table bg-cab-table td-boder" style="">11ª Classe</td>
            <td class=" td cab-table bg-cab-table td-boder" style="">12ª Classe</td>
            ...
            @foreach (componentes_disciplinas()->where('id_componente', $componente->id)->get() as $disciplina)
                @foreach ($notas as $nota)
                    @isset($nota[$disciplina->vc_acronimo])
                        @php
                            $medias_anuas_disciplina = medias_anuas_disciplina($aluno->id, $disciplina->vc_acronimo, [10, 11, 12]);
