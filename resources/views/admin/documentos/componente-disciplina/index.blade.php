                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @if (Auth::user()->vc_tipoUtilizador != 'Professor')
                                        <a href="{{ route('admin.documentos.componentes-disciplinas.editar', $componente->id) }}"
                                            class="dropdown-item">Editar</a>
                                        <a href="{{ route('admin.documentos.componentes-disciplinas.eliminar', ['id' => $componente->id]) }}"
                                            class="dropdown-item"
