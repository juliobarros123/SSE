...
@section('titulo', 'Imprimir Relatório de Candidatos Aceitos ')

@section('conteudo')
    <div class="card mt-3">
        <div class="card-body">
            <h3>Imprimir Relatório de Candidatos Aceitos</h3>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('relatorios.candidatos_aceitos.imprimir') }}" class="row" method="POST">
                @csrf
