        ...
        <body style="background-image: url('images/cartao/funcionario/cartao.jpg');;background-position: top left;
...
<div class="titulo">Passe de funcionário</div>
                ...
                <div class="losango" style="background-image: url(<?php echo $funcionario->vc_foto ?>);  background-size: cover;  border:4px solid #1151a0;">
