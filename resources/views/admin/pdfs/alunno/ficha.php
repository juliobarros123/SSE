...
<div style=" " >
 ...
 <img src="<?php echo $alunno->vc_imagem; ?>" style="float: right;" width="100" height="100" class="logo" />
    ...
    <table class="style-table">
        <th>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?= $alunno->vc_classe?></td>
                <td style="text-align: center;"><?= $alunno->ya_inicio/ $alunno->ya_fim?></td>
