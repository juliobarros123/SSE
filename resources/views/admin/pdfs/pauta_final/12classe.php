        ...
        <thead class="">
                ...
                <?php foreach ($disciplinas as $disciplina) { ?>
                    ...
                    <?php if ($disciplinas_terminas->where('id', $disciplina->id)->count()) {
                        ...
                        <?php for ($cont = $detalhes_turma->vc_classe - 1; $cont >= 10; $cont--) { ?>
                            <?php $QtDeClasses++; ?> <?php } ?>
                        <?php if ($disciplinas_terminas->where('id', $disciplina->id)->count() && $detalhes_turma->vc_classe == '12' && temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)) { ?>
                            <th colspan="<?php echo 6 + $QtDeClasses ?>" rowspan="1" class="th " style="text-align: center;"><?php echo $disciplina->vc_acronimo ?></th>
                        <?php } else if ($disciplinas_terminas->where('id', $disciplina->id)->count() && $detalhes_turma->vc_classe == '12' && !temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)) { ?>
                            <th colspan="<?php echo 6 + temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)  ?>" rowspan="1" class="th " style="text-align: center;"><?php echo $disciplina->vc_acronimo ?></th>
                        <?php } else if ($disciplinas_terminas->where('id', $disciplina->id)->count() && !temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)) { ?>
                            <th colspan="<?php echo 5 + temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)  ?>" rowspan="1" class="th " style="text-align: center;"><?php echo $disciplina->vc_acronimo ?></th>
            ...
            <tr>
                <?php foreach ($disciplinas as $disciplina) { ?>
                    ...
                    <?php if ($disciplinas_terminas->where('id', $disciplina->id)->count() && $detalhes_turma->vc_classe == '12') { ?>
                ...
                if (!in_array($aluno->id, $processos)) { ?>
                    ...
                    <tr class="">
                        ...
                        ?>
                            ...
                            <?php if ($disciplinas_terminas->where('id', $disciplina->id)->count() && $detalhes_turma->vc_classe == '12') { ?>
                                <td colspan="1" rowspan="1" class="td" style=" color:<?php echo $mft >= 10 ? 'blue' : 'red' ?>"><?php echo $mft; ?></td>
                                <td colspan="1" rowspan="1" class="td" style=" color:<?php echo  $mfd >= 10 ? 'blue' : 'red' ?>"><?php echo $mfd; ?></td>
                            <?php } else { ?>
                            ...
                            <?php if ($disciplinas_terminas->where('id', $disciplina->id)->count() && temDisciplinaNoClasseAnterior($disciplina->id, $detalhes_turma->vc_classe, $detalhes_turma->it_idCurso)) { ?>
                                ...
                                <td colspan="1" rowspan="1" class="td" style=" color:<?php echo $cfd >= 10 ? 'blue' : 'red' ?>"><?php echo  $cfd;
                                                                                                                                ?></td>
                                <?php
    ...
    <div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="td"><?php echo round(((($alunos->count() - $ttlReprovados) / $alunos->count()) * 100), 0, PHP_ROUND_HALF_UP) . '%' ?></td>
            ...
            <tr>
                ...
                <td class="td"><?php echo round((($ttlReprovados / $alunos->count()) * 100), 0, PHP_ROUND_HALF_UP) . '%' ?></td>
