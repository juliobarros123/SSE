...
<body>
    ...
    <br>
    <div class="text-center">
        <h3 class="tema">Lista dos Selecionados de
            <?php if ($curso):
                echo ($curso);
            else:
        ...
        <tbody>
            ...
            <?php foreach ($alunos as $aluno): ?>
                <tr>
                    ...
                    <td class="text-left">
                        <?php echo $aluno->vc_primeiroNome . " " . $aluno->vc_nomedoMeio . " " . $aluno->vc_ultimoaNome; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <!-- <?php if ($aluno->it_media >= 10):
                            echo "<b>$aluno->it_media<b>";
                        else:
                            echo "<b class='text-danger'>$aluno->it_media</b>";
                        endif; ?> -->
    ...
    <table class="table1">
        <tr class="tr1">
            <th class="th1" style="padding-left: 80px;padding-right: 100px;">
                <br> O COORDENADOR DA COMISSÃO <br>
