                        ...
                        <div class="col-sm-3 statistic-card m-1 ">
                            ...
                            <div class="mt-2 mb-0 text-muted text-xs">
                                ...
                                <span class="text-success mr-2"><i class="fa fa-calendar"></i>
                                    ...
                                    Multa:
                                    {{-- @dump(date('Y-' . obterNumeroMes(fh_meses()[$i]) . "-$mes_valido->dias_multa")) --}}
                                    {{ fha_calcular_valor_pagar(date('Y-' . obterNumeroMes(fh_meses()[$i]) . "-$mes_valido->dias_multa"), $mes_valido->valor, $mes_valido->dias_multa, $mes_valido->multa_valor) }}akz
