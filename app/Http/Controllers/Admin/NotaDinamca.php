...
//   dd(  $detalhes['estados_de_notas_unica']);
   ...
   ->get();
    ...
    {
        // dd($it_disciplina);
        $dd= $this->turmasProfessor()->where('id_disciplina', $it_disciplina)->where('id_turma', $it_idTurma)->first();
    //   dd($dd);
    //   dd($dd);
           ...
           ->get();
            ...
            if (!$linha->count()) {
                Nota::create([
                          ...
                          'fl_nota1' =>$notas['fl_nota1'] ,
                          'fl_nota2' => $notas['fl_nota2'],
                          'fl_mac' => $notas['fl_mac'],
            ...
            // } else {
                    //     return redirect('nota_em_carga/buscar_alunos/')->with('ExisteNota', '1');
                    // }
        //         } else {
                
        //      // return  redirect('nota_em_carga/buscar_alunos/')->with('notaIncompleta', '1');
        //         }
        //     } else {
        //         return redirect('nota_em_carga/buscar_alunos/')->with('semNotas', '1');
        //     }
        // } else{
